...
def main():
	...
	with loading_context():
		...
		if settings["model_version"] == "3.6B":
			...
			generator = StageC_SpectraOne(c_cond=2048, c_hidden=[2048, 2048], blocks=[[4, 12], [12, 4]], nhead=[32, 32], c_clip_text=768, c_clip_text_pooled=768, flash_attention=flash_attention)
			print()
		else:
